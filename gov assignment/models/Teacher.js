...
var Teacher = {
    getAllTasks: function (callback) {
        var lala = db.query("Select * from school_teacher", callback);
        console.log(lala);
        return lala;
    },
    ...
    getStudents: function (teacher, callback) {
        ...
        return db.query("select * from school_teacher_student where teacherEmail in (?)", [teacher], callback);
    },
    ...
    getStudentRecipients: function (teacher, studentList, callback) {
        return db.query("select ts.studentEmail from school_teacher_student ts, school_suspend_student st where ts.studentEmail != st.studentEmail and ts.teacherEmail = ? and ts.studentEmail = ? ", [teacher, studentList], callback);
    },
